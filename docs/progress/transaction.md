...
### ⚠️ 2026-04-25 成交详情主机字段展示口径同步

- **现象**：管理后台成交详情仍显示"主机功率"，并拼接"千瓦"
- **修复**：`admin/src/views/transaction/index.vue` 改为"主机型号"，不再拼接"千瓦"，`0` / 空值显示为 `-`
- **说明**：本次只改展示口径，数据库字段仍沿用 `engine_power`
